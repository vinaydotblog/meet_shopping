...
?>  <table width="75%" border="1">
 ...
 <tr>
      <td>Type</td>
      <td><select name="u_status" size="1">
            <option value="Active">Active</option>
            <option value="DeActive">De-Active</option>
          </select></td>
    </tr>   <tr>
      <td>&nbsp;</td>  <td><input type="submit" name="b1"></td>
    </tr></form>
  </table>
</center>
</body>
